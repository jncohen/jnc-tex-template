...
%   - \RecustomVerbatimEnvironment (fancyvrb, also pre-loaded) overrides
%     the fontsize that Pandoc bakes into Highlighting / verbatim.
...
\ifjncmethods
  ...
  %% Fira Code at footnotesize inside highlighted blocks
  \RecustomVerbatimEnvironment{Highlighting}{Verbatim}{%
    commandchars=\\\{\},%
    fontsize=\footnotesize%
  }

  %% --- code OUTPUT: shaded verbatim, no page split ---
  \RecustomVerbatimEnvironment{verbatim}{Verbatim}{fontsize=\footnotesize}
  \surroundwithmdframed[%
    backgroundcolor=codeoutputbg,%
    linewidth=0pt,%
    skipabove=3pt,%
    skipbelow=3pt,%
    innerleftmargin=6pt,%
...
$if(author_email)$\href{mailto:$author_email$}{$author_email$}\par$endif$%
$if(author_web)$\href{$author_web$}{$author_web$}\par$endif$%
