...
%%
%% Solution: supply contact details via top-level jnc_author_* YAML variables,
%% which Quarto does not process and therefore passes through unchanged.
%%
%%   jnc_author_dept:   Department of Sociology
%%   jnc_author_inst:   Queens College, City University of New York
%%   jnc_author_addr:   65-30 Kissena Blvd., Queens, NY 11367, USA
%%   jnc_author_email:  joseph.cohen@qc.cuny.edu
%%   jnc_author_web:    https://jncohen.commons.gc.cuny.edu
%%   jnc_author_orcid:  0000-0002-6197-4453
%%
...
$if(jnc_author_dept)$$jnc_author_dept$\par$endif$%
$if(jnc_author_inst)$$jnc_author_inst$\par$endif$%
$if(jnc_author_addr)$$jnc_author_addr$\par$endif$%
$if(jnc_author_email)$\texttt{$jnc_author_email$}\par$endif$%
$if(jnc_author_web)$$jnc_author_web$\par$endif$%
$if(jnc_author_orcid)$ORCID: $jnc_author_orcid$\par$endif$%
}%
\fi
$endif$
}
