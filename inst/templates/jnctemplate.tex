...
\newcommand{\jncmethodscodescale}{0.90}
  ...
  \else
    ...
    \ifjncmethods
      ...
      \IfFileExists{FiraCode.sty}{%
        \usepackage[scale=\jncmethodscodescale]{FiraCode}%
      }{%
...
$if(numbersections)$
  ...
  \else\ifjncdemography
    \titleformat{\section}{\large\bfseries}{\thesection}{1em}{}[\jncdemorule\vspace{0.4em}]
    ...
    \titlespacing{\subsubsection}{0pt}{1.25ex plus 0.25ex}{-0.5ex}
  \else\ifjncmethods
    \titleformat{\section}{\large\bfseries\color{jncaccent}}{\thesection}{1em}{}[\jncmetrule\vspace{0.4em}]
...
$else$
  ...
  \ifjnchumanities
    ...
    \titlespacing{\subsubsection}{0pt}{1.25ex plus 0.25ex}{-0.5ex}
  \else\ifjncdemography
    \titleformat{\section}{\large\bfseries}{}{0pt}{}[\jncdemorule\vspace{0.4em}]
    ...
    \titlespacing{\subsubsection}{0pt}{1.25ex plus 0.25ex}{-0.5ex}
  \else\ifjncmethods
    \titleformat{\section}{\large\bfseries\color{jncaccent}}{}{0pt}{}[\jncmetrule\vspace{0.4em}]
